...
You must choose a paper that was published in one of the three most
recent VLDB conferences: [VLDB 2023](http://vldb.org/2023/), [VLDB 2024](http://vldb.org/2024/) or [VLDB 2025](https://vldb.org/2025). As each conference accepts hundreds of papers, this may be rather overwhelming. To help narrow your choice,
you can choose to focus on just the papers that were awarded prizes. The prize-winning papers are listed at the following links:

- [VLDB 2023 award papers](https://vldb.org/2023/?conference-awards):
  The "best demo" papers are not eligible, but all others listed here are eligible.
- VLDB 2024 award papers: I couldn't find a webpage that lists these, but based on a Facebook post these were the winners:
